     ...
     this.login = function(options, successCallback, failureCallback) {
         ...
         function extractLoginOptions(loginOptions) {
             if (!kony.sdk.isNullOrUndefined(loginOptions)) {
                 ...
                 if ((providerType === kony.sdk.constants.AUTH_PROVIDER_TYPE_OAUTH2) && (loginOptions[kony.sdk.constants.ENABLE_REFRESH_LOGIN] === true)) {
     ...
     */
     ...
     this.manageGeoBoundariesCallback = function(data) {
         ...
         if (data.state.toLocaleUpperCase() === kony.sdk.constants.SUCCESS_STRING) {
             ...
             if (!kony.sdk.isNullOrUndefined(KNYMessagingService.geoBoundariesResponse) && !kony.sdk.isNullOrUndefined(KNYMessagingService.refreshBoundariesSuccessCallback) && typeof(KNYMessagingService.refreshBoundariesSuccessCallback) == kony.sdk.constants.FUNCTION_STRING) {
